...
public class Sparty extends Sprite
{
  ...
  Sparty() throws SlickException
  {
    ...
    Image[] standing =
    {
      new Image("data/SpartyIdle1.png"), new Image("data/SpartyIdle2.png")
    };
    Image[] tired =
    {
      new Image("data/SpartyMoved1.png"), new Image("data/SpartyMoved2.png")
    };
    Image[] grabbed =
    {
      new Image("data/SpartySelected1.png"), new Image("data/SpartySelected2.png")
    };
    Image[] translate =
    {
      new Image("data/SpartyMoving1.png"), new Image("data/SpartyMoving2.png")
    };
